...
def prep_backup(customer):
    backup_dir = "/root/Desktop/Customer_Backups"
...
def main():
    ...
    print("[*] Checking how much data is going to be backed up, this might take a few moments.")
    ...
    print("[+] Starting data recovery now...")
